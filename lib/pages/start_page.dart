              ...
              Column(
                children: [
                  Row(
                    ...
                    children: [
                      CustomTile(title: 'Option 1',url: 'https://app.hhaexchange.com/identity/account/login', backgroundImage: sqr1, frontOverlayImage:  'assets/images/sqr1_f.png',isweb: false,nav: HomePage()),
                      CustomTile(title: 'Option 2',url: 'https://app.workbright.com/users/sign_in', backgroundImage: sqr2, frontOverlayImage: sqr2f,isweb: false, nav: HomePage(),)
                    ],
                  ),
                  SizedBox(height: 2.h,),
                  Center(
